...
import { getHoursFromMs, getNow } from '@shared/utils/timeHelper';
...
function FeedbackInputArticle() {
  ...
  const isFeedbackWritable = useMemo(
    () =>
      ...
      getHoursFromMs(+getNow() - latestFeedbackDate.value) > 24,
    [latestFeedbackDate]
  );
    ...
    <article>
      ...
      <div css={buttonContainerStyle}>
        ...
        {feedbackMutation.isLoading ? (
          <Text size="size12" css={errorMessageStyle}>
            전송중입니다. 탭을 닫지 말고 기다려주세요...
          </Text>
        ) : null}
        {feedbackMutation.isSuccess ? (
          <Text size="size12" color="green" css={errorMessageStyle}>
            전송완료!
          </Text>
        ) : null}
      </div>
